<<<<<<< HEAD
# BLASTX-Discord-Bot
[BLASTX Discord](https://discordapp.com/invite/dRSTFBq)
=======
# BlastX-Bot
[BlastX Discord](https://discordapp.com/invite/dRSTFBq)
>>>>>>> 2cbb8419e753c5ab8702a90e97f47b3f2d7a7272


These files are intended to function as a multi-functional bot for BLASTX (BLAST)

# Requirements
* discord.py installed
* Python 3.6+
* A MySQL database
* The BLASTX wallet w/ RPC enabled.
