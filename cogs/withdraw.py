...
class Withdraw:
    ...
    async def withdraw(self, ctx, address: str, amount: float):
        """Withdraw coins from your account to any Blast address"""
        ...
        if txid is None:
            ...
            await self.bot.say("{} **Withdrew {} BLAST! <:blast:469787831137599488>**{} ".format(ctx.message.author.mention, str(amount), txid))
