...
class Mining:
    ...
    async def mining(self, ctx):
        ...
        embed.set_author(name='BLAST Mining Information', icon_url="https://blastexchange.com/Blastx_Logo.png")
        ...
        try:
            async with ClientSession() as session:
                async with session.get("http://api.bsod.pw/api/currencies", headers=headers) as response:
                    ...
                    miningData = json.loads(responseRaw)["BLAST"]
                    ...
                    embed.set_footer(text="ccminer.exe -a lyra2v2 -o stratum+tcp://pool.bsod.pw:1982 -u <Wallet Address>.<Rigname> -p c=BLAST -R 5")
                    await self.bot.say(embed=embed)
